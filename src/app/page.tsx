...
export default function page() {
  return (
    <>
      ...
      <section className="lg:px-36 py-16 bg-[#fffbef]">
        <h3 className="text-blue-500 lg:text-5xl text-3xl font-semibold text-center">
          We are Experienced in making you
          <br />
          very Beautiful
        </h3>
        <div className="grid lg:grid-cols-3 gap-6 lg:h-[614px] rounded-[40px] lg:w-full overflow-hidden mt-6">
