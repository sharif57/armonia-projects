                ...
                <div className="w-[600px] mx-auto shadow-2xl p-8 rounded-lg ">
                    ...
                    <div className="text-center mb-6 space-y-3">
                        <div className='flex items-center lg:gap-40 gap-16'>
                            ...
                            <h1 className="text-2xl font-bold text-black font-Playfair_Display">Reset Password</h1>
                        </div>
                        <p className="text-gray-400">Your password must be 8-10 character long.</p>
                    </div>
