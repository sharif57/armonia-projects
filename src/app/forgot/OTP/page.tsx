            ...
            <div className="w-[600px] mx-auto shadow-2xl p-8 rounded-lg px-12">
                ...
                <div className="text-center mb-6 space-y-3">
                    <div className='flex items-center lg:gap-40 gap-16'>
                        ...
                        <h1 className="text-2xl font-bold text-black font-Playfair_Display">Verify OTP</h1>
                    </div>
                    <p className="text-gray-400">Enter the code that was sent to your email.</p>
                </div>
                ...
                <div className="text-center text-sm text-gray-500 flex justify-around">
                    ...
                    <Link href="/resend-otp" className="text-green-500 ml-1">Resend</Link>
                </div>
